...
const useStyles = makeStyles<{ debugDragRegion?: boolean }, "avatar">()((
  ...
  return {
    ...
    logo: {
      ...
      "svg:not(.MuiSvgIcon-root)": { fontSize: "1em" },
      "&:hover": { backgroundColor: tc(theme.palette.common.white).setAlpha(0.08).toRgbString() },
      "&.Mui-selected": {
        backgroundColor: theme.palette.appBar.primary,
        color: theme.palette.common.white,
      },
      "&.Mui-disabled": { color: "currentColor", opacity: theme.palette.action.disabledOpacity },
    },
    dropDownIcon: { fontSize: "12px !important" },
    start: { gridArea: "start", display: "flex", flex: 1, alignItems: "center" },
    startInner: {
      display: "flex",
      alignItems: "center",
    ...
    end: { gridArea: "end", flex: 1, display: "flex", justifyContent: "flex-end" },
    endInner: {
      display: "flex",
      alignItems: "center",
      ...NOT_DRAGGABLE_STYLE, // make buttons clickable for desktop app
    ...
    tooltip: { marginTop: `${theme.spacing(0.5)} !important` },
    avatar: {
      color: theme.palette.common.white,
    ...
    layoutButtonLabel: { lineHeight: 1, display: "inline-flex", alignItems: "center" },
  };
});
              ...
              >
                <Stack direction="row" alignItems="center" gap={0.2}>
                  ...
                  <Typography
                    variant="body2"
                    component="span"
                    className={classes.layoutButtonLabel}
                  >
                    {t("layout")}
                  </Typography>
                  <ChevronDown12Regular
