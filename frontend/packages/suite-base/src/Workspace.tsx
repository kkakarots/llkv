...
function WorkspaceContent(props: WorkspaceProps): React.JSX.Element {
  ...
  const leftSidebarItems = useMemo(() => {
    const items = new Map<LeftSidebarItemKey, SidebarItem>([
      ["panel-settings", { title: tOthers("Panel"), component: PanelSettingsSidebar }],
      ["topics", { title: tOthers("Topics"), component: TopicList }],
      [
        "alerts",
        {
      ...
      // ["layouts", { title: tOthers("Layouts"), component: LayoutBrowser }],
    ]);
    return items;
