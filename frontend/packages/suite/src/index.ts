...
export type SettingsTreeNode = {
  ...
  /**
   * Optional substring used to further filter children when visibility filter is enabled.
   * If provided, a custom option will be available in the UI to show only children whose key or label
   * contains this substring (case-sensitive match, UI may display a localized label).
   */
  filterMatchSubstring?: string;
};
